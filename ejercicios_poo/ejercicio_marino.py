...
# clase Pulpo() que herede Marino, pero modificar el mensaje de hablar 
# por "Soy un Pulpo". Por ultimo, crear una clase Foca(), heredada de Marino,
# pero que tenga un atributo nuevo llamado mensaje y que muestre ese mensaje como parametro
